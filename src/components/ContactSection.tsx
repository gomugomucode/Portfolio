            ...
            <div className="p-6 rounded-2xl bg-slate-900/40 backdrop-blur-sm border border-slate-800 space-y-6 shadow-lg shadow-black/10">
              ...
              <div className="space-y-4">
                <a href="mailto:contact@anupambaral.com.np" className="flex items-center gap-4 group">
                  <div className="p-3 rounded-xl bg-emerald-500/10 text-emerald-500 border border-emerald-500/20 group-hover:bg-emerald-500 group-hover:text-white transition-all duration-300">
                ...
                <a href="tel:+977-9767606302" className="flex items-center gap-4 group">
                  <div className="p-3 rounded-xl bg-cyan-500/10 text-cyan-500 border border-cyan-500/20 group-hover:bg-cyan-500 group-hover:text-white transition-all duration-300">
          ...
          <div className="lg:col-span-2">
            <form onSubmit={handleSubmit} className="bg-slate-900/40 backdrop-blur-sm border border-slate-800 rounded-2xl p-6 md:p-8 space-y-5 shadow-lg shadow-black/10">
              ...
              <button type="submit" disabled={sending}
                className="w-full flex items-center justify-center gap-2 bg-emerald-600 text-white px-6 py-3.5 rounded-xl font-bold hover:bg-emerald-500 transition-all active:scale-95 disabled:opacity-50 relative overflow-hidden group">
                {sending ? (
