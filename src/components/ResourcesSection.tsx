            ...
            <section className="w-full max-w-6xl mx-auto px-4 pb-20">
                ...
                <header className="text-center mb-12">
                    ...
                    <p className="max-w-2xl mx-auto text-slate-400 text-sm md:text-base leading-relaxed">
                        A curated collection of technical assets, deployment strategies, and career optimization tools designed to <span className="text-emerald-400/90 font-medium">accelerate professional scaling</span> and bridge the gap between development and production.
                    </p>
