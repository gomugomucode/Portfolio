            ...
            <section className="w-full max-w-6xl mx-auto px-4 pb-20">
                ...
                <header className="text-center mb-12">
                    <div className="flex items-center justify-center gap-3 mb-4">
                        <BriefcaseBusiness className="w-8 h-8 text-violet-500" />
                        <h2 className="text-3xl md:text-4xl font-bold text-white tracking-tight">
                            Developer <span className="text-violet-500">Resources</span>
                        </h2>
                    </div>

                    <p className="max-w-2xl mx-auto text-slate-400 text-sm md:text-base leading-relaxed">
                        A curated collection of technical assets, deployment strategies, and career optimization tools designed to <span className="text-violet-400 font-medium">accelerate professional scaling</span> and bridge the gap between development and production.
                    </p>

                    <div className="w-12 h-1 bg-violet-500/20 rounded-full mx-auto mt-6" />
                </header>
                    ...
                    {resources.map((res, index) => (
                        ...
                        >
                            ...
                            <header className="flex items-start gap-4 mb-3">
                                ...
                                <h3 className="text-lg font-bold text-slate-100 group-hover:text-violet-400 transition-colors mt-1 leading-tight">
                                    {res.title}
                                </h3>
                            </header>
